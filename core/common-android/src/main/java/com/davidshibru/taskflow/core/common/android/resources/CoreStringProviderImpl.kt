...
class CoreStringProviderImpl @Inject constructor(
    ...
    override val authErrorMessage: String = context.getString(R.string.common_auth_error_message)
    ...
    override val deleteAction = context.getString(R.string.common_delete)
    override val cancelAction = context.getString(R.string.common_cancel)
