...
class AppNavigatorImpl @Inject constructor(
    ...
    private val _navigationEvents = Channel<NavigationIntent<Route>>(Channel.Factory.BUFFERED)
    override val navigationEvents: Flow<NavigationIntent<Route>> = _navigationEvents.receiveAsFlow()
    private var lastNavigationIntent: NavigationIntent<Route>? = null
    ...
    private fun sendNavigationIntent(intent: NavigationIntent<Route>) {
